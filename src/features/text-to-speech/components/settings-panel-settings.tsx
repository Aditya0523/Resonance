            ...
            <form.Field key={slider.id} name={slider.id}>
              {(field) => (
                <Field>
                  ...
                  {/* Why this instead of just editing the Slider component?
                    The Slider is a third-party/shared component — 
                    you shouldn't fork it just to tweak sizing on one usage. 
                    **:data-[slot=...] lets you reach inside and style specific 
                    internal parts per usage from the outside, 
                    like CSS ::part() but with Tailwind syntax. */}
                  <Slider
